			...
			<div class="row mb-5">
				<div class="col-md-6 col-lg-3">
					<div class="ftco-footer-widget mb-4">
						...
						<p><b style="color: rgba(255, 255, 255, 0.9);">Need help?</b> <br> Email us at: <a style="text-decoration: underline;" href="">nguyenminhnhut435@gmail.com</a> <br> or give us a call at: <a style="text-decoration: underline;" href="">0909374409</a>.</p>
						<ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-3">
							...
							<li class="ftco-animate"><a href="https://www.facebook.com/dhspkt.hcmute"><span class="fa fa-instagram"></span></a></li>
						</ul>
					</div>
				</div>
				<div class="col-md-6 col-lg-3">
					...
					<div class="ftco-footer-widget mb-4">
						...
						<p><b style="color: rgba(255, 255, 255, 0.9);">Happy Shoes Shop in your Inbox</b> <br> For special offers, new goodies, and the latest news join our mailing list.</p>
							...
							<div class="form-group">
								<input name="subscribeEmail" type="text" class="form-control mb-2 text-center" placeholder="Enter email address">
