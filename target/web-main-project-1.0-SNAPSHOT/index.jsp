...
<head>
    ...
    <link rel="icon" href="/images/test-image" type="images/test-image" />
...
<body>
    ...
    <section class="ftco-section ftco-intro" style="background-image: url(images/test-image.jpg);">
            <div class="overlay"></div>
            <div class="container">
                    <div class="row">
            ...
            <div class="container">
                    ...
                    <div class="row">
                            <div class="col-md-6 col-lg-3 ftco-animate">
                                    <div class="staff">
                                            <div class="img" style="background-image: url(images/test-image.jpg);"></div>
            ...
            <div class="container">
                    <div class="row d-flex">
                            <div class="col-md-6 d-flex">
                                    <div class="img img-2 w-100 mr-md-2" style="background-image: url(images/test-image.jpg);"></div>
                                    <div class="img img-2 w-100 ml-md-2" style="background-image: url(images/test-image.jpg);"></div>
                            </div>
                            <div class="col-md-6 ftco-animate makereservation p-4 p-md-5">
                                    <div class="heading-section ftco-animate mb-5">
                                            <span class="subheading">This is our secrets</span>
                                            <h2 class="mb-4">h2-content</h2>
                                            <p>p-content
                                            </p>
                    ...
                    <div class="row">
                            <div class="col-md-4 ftco-animate">
                                    <div class="blog-entry">
                                            <a href="blog-single.jsp" class="block-20" style="background-image: url('images/test-image.jpg');">
                                            </a>
                                            <div class="text px-4 pt-3 pb-4">
                                                    ...
                                                    <h3 class="heading"><a href="blog-single.jsp">Blog1</a></h3>
                                                    <p class="clearfix">
                            ...
                            <div class="col-md-4 ftco-animate">
                                    <div class="blog-entry">
                                            ...
                                            <div class="text px-4 pt-3 pb-4">
                                                    ...
                                                    <h3 class="heading"><a href="blog-single.jsp">Blog2</a></h3><br>
                                                    <p class="clearfix">
                                                            <a href="blog-single.jsp" class="float-left read btn btn-primary">Read more</a>
                                                            <a href="blog-single.jsp" class="float-right meta-chat"><span class="fa fa-comment"></span> 3</a>
                                                    </p>
                            ...
                            <div class="col-md-4 ftco-animate">
                                    <div class="blog-entry">
                                            ...
                                            <div class="text px-4 pt-3 pb-4">
                                                    ...
                                                    <h3 class="heading"><a href="blog-single.jsp"></a>h3-content</h3><br>
                                                    <p class="clearfix">
                                                            <a href="blog-single.jsp" class="float-left read btn btn-primary">Read more</a>
                                                            <a href="blog-single.jsp" class="float-right meta-chat"><span class="fa fa-comment"></span> 3</a>
                                                    </p>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb ftco-intro bg-primary">
            <div class="container py-5">
                    <div class="row py-2">
                            <div class="col-md-12 text-center">
                                    <h2>contribute to our development</h2>
                                    <a href="reservation.jsp" class="btn btn-white btn-outline-white">Let me know what you think</a>
                            </div>
                    </div>
            </div>
    </section>
